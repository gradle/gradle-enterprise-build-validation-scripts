...
public class GradleEnterpriseApiClient {
    ...
    public BuildValidationData fetchBuildValidationData(NumberedBuildScan buildScan) {
        ...
        try {
            ...
            throw new UnknownBuildAgentException(BuildScanUrl.from(baseUrl, buildScanId), build.getBuildToolType());
    ...
    public static class UnknownBuildAgentException extends FetchToolException {
        public UnknownBuildAgentException(BuildScanUrl buildScanUrl, String buildAgent) {
            super(String.format("Build scan %s was generated by an unknown build agent: %s.", buildScanUrl, buildAgent));
        }
    }
}
