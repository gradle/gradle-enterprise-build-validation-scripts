...
public final class GradleEnterpriseApiClient {
    ...
    public BuildScanData fetchBuildScanData(NumberedBuildScan buildScan) {
        ...
        if (buildToolType.equals(GRADLE)) {
            return analyzeGradleBuild(runNum, buildScanDataLoader.loadDataForGradle(buildScan.uri()));
        } else if (buildToolType.equals(MAVEN)) {
            return analyzeMavenBuild(runNum, buildScanDataLoader.loadDataForMaven(buildScan.uri()));
        } else {
