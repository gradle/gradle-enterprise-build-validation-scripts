...
{
  local first_option all_short_options='hbcsriat'
  first_option="${1:0:1}"
...
print_help()
{
  ...
  printf 'Usage: %s [-h|--help] [-b|--git-branch <arg>] [-c|--config <arg>] [-s|--gradle-enterprise-server <arg>] [-r|--git-repo <arg>] [-i|--(no-)interactive] [-a|--args <arg>] [-t|--tasks <arg>]\n' "$0"
  printf '\t%s\n' "-h, --help: Prints help"
}
