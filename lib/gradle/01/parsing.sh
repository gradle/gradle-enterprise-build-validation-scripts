...
{
	local first_option all_short_options='bcsuiateh'
	first_option="${1:0:1}"
...
print_help()
{
	...
	printf 'Usage: %s [-b|--git-branch <arg>] [-c|--config <arg>] [-s|--server <arg>] [-u|--git-url <arg>] [-i|--(no-)interactive] [-a|--args <arg>] [-t|--tasks <arg>] [-e|--(no-)enable-gradle-enterprise] [-h|--help]\n' "$0"
