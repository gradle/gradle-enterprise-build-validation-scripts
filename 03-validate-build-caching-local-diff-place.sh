...
# shellcheck source=experiments/lib/03/parsing.sh
source "${SCRIPT_DIR}/lib/03/parsing.sh" || { echo "Couldn't find '${SCRIPT_DIR}/lib/03/parsing.sh' parsing library."; exit 1; }
