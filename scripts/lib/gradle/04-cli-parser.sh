...
{
  local first_option all_short_options='hvi12mAUP'
  first_option="${1:0:1}"
...
print_help()
{
  ...
  printf 'Usage: %s [-h|--help] [-v|--version] [-i|--(no-)interactive] [-1|--first-build <arg>] [-2|--second-build <arg>] [--(no-)debug] [-m|--mapping-file <arg>] [-A|--access-key <arg>] [-U|--username <arg>] [-P|--password <arg>]\n' "$0"
  printf '\t%s\n' "-h, --help: Prints help"
