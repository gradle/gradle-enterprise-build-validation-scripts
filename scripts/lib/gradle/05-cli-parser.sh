...
{
  local first_option all_short_options='hvbsrpiateAUPBm'
  first_option="${1:0:1}"
...
print_help()
{
  ...
  printf 'Usage: %s [-h|--help] [-v|--version] [-b|--git-branch <arg>] [-s|--gradle-enterprise-server <arg>] [-r|--git-repo <arg>] [-p|--project-dir <arg>] [-i|--(no-)interactive] [--(no-)debug] [-a|--args <arg>] [-t|--tasks <arg>] [-e|--(no-)enable-gradle-enterprise] [-A|--access-key <arg>] [-U|--username <arg>] [-P|--password <arg>] [-B|--build-scan <arg>] [-m|--mapping-file <arg>]\n' "$0"
  printf '\t%s\n' "-h, --help: Prints help"
  ...
  do
    ...
    case "$_key" in
      ...
      -A|--access-key)
        test $# -lt 2 && die "Missing value for the optional argument '$_key'." 1
        _arg_access_key="$2"
        _args_export_api_args_opt+=("${_key}" "$2")
        shift
        ;;
      --access-key=*)
        _arg_access_key="${_key##--access-key=}"
        _args_export_api_args_opt+=("$_key")
        ;;
      -A*)
        _arg_access_key="${_key##-A}"
        _args_export_api_args_opt+=("$_key")
        ;;
      -U|--username)
        test $# -lt 2 && die "Missing value for the optional argument '$_key'." 1
      ...
      -B|--build-scan)
        ...
        ;;
      --build-scan=*)
        _arg_build_scan="${_key##--build-scan=}"
        ;;
      -B*)
...
_args_export_api_args=("${_args_export_api_args_opt[@]}" "${_args_export_api_args_pos[@]}")
