#!/usr/bin/env bash
#
# Runs Experiment 02 - Validate Gradle Local Build Caching - Same project location
#
# Invoke this script with --help to get a description of the command line arguments
#
readonly EXP_NAME="Validate Gradle Local Build Caching - Same project location"
