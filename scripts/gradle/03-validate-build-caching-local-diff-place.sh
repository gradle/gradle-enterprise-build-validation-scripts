#!/usr/bin/env bash
#
# Runs Experiment 02 - Validate Gradle Build Caching - Local -> Local
#
# Invoke this script with --help to get a description of the command line arguments
#
readonly EXP_NAME="Validate Gradle Build Caching - Local -> Local"
...
print_quick_links() {
 ...
 summary_row "Executed cacheable tasks:" "${base_urls[0]}/s/${build_scan_ids[1]}/timeline?cacheability=cacheable&outcome=SUCCESS,FAILED&sort=longest"
